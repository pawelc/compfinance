...
head(cbind(sbux.ccret, msft.ccret,sbux.ret,msft.ret))
...
dates.sbux = as.yearmon(rownames(sbux.df), format="%m/%d/%Y")
dates.msft = as.yearmon(rownames(msft.df), format="%m/%d/%Y")
